<x-app-layout>
    <div
        class="h-screen bg-gray-50 flex flex-col overflow-hidden"
        x-data="{
            mapMode: 'default',
    ...
    >
        ...
        <div x-data="{ sideMenuOpen: false }" class="z-[180] absolute top-0 left-0">
            ...
            >
                ...
                <div class="flex items-center gap-4 mb-8 pb-6 border-b border-gray-100">
                    <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white text-2xl font-black italic shadow-lg shrink-0">
                ...
                <nav class="space-y-2 flex-1">
                    ...
                    >
                        ...
                        <span class="font-black text-xs uppercase tracking-widest text-gray-600 group-hover:text-orange-600">
                ...
                <div class="pt-6 border-t border-gray-100 space-y-3">
                    <div class="rounded-2xl bg-gradient-to-r from-orange-500 via-orange-500 to-blue-700 text-white p-4 shadow-[0_15px_30px_-10px_rgba(249,115,22,0.35)]">
        ...
        <main class="flex-1 relative w-full h-full overflow-hidden">
            ...
            <div class="absolute inset-0 w-full h-full overflow-hidden">
                ...
                {{-- SOBREPOSIÇÃO SUAVE --}}
                <div class="absolute inset-0 bg-gradient-to-b from-black/5 via-transparent to-black/10 pointer-events-none z-[5]"></div>

                {{-- TOP PILL DE GANHOS --}}
                <div class="absolute top-4 inset-x-0 z-[120] pointer-events-none px-4">
                    <div class="max-w-md mx-auto flex justify-center">
                        <div class="pointer-events-auto bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-full px-5 py-3 shadow-[0_15px_35px_-10px_rgba(37,99,235,0.45)] border border-blue-400/20 backdrop-blur-xl flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-white/15 flex items-center justify-center border border-white/10 shadow-inner">
                                <span class="text-xl">🪙</span>
                            </div>
                ...
                <div class="absolute bottom-0 inset-x-0 z-[145] pointer-events-none">
                    <div class="max-w-md mx-auto pointer-events-auto">
                        <div class="bg-white/96 backdrop-blur-2xl rounded-t-[2rem] shadow-[0_-20px_40px_-20px_rgba(0,0,0,0.35)] border-t border-white/70 px-6 pt-4 pb-[max(1.25rem,env(safe-area-inset-bottom))]">
                            ...
                            <div class="flex items-center justify-center mb-5">
                                <div class="text-center">
                                    <p
                                        class="text-3xl font-black tracking-tight transition-all duration-300"
                                        :class="driverOnline ? 'text-blue-700' : 'text-gray-900'"
                                        x-text="driverOnline ? 'Procurando viagens' : 'Offline'"
                                    ></p>

                                    <p
                                        class="text-[11px] font-black uppercase tracking-widest mt-1 transition-all duration-300"
                                        :class="driverOnline ? 'text-orange-500' : 'text-gray-400'"
                                        x-text="driverOnline ? 'Movvia ativo no mapa' : 'Motorista indisponível'"
                                    ></p>
                                </div>
                            </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            document.addEventListener('livewire:navigated', initDriverMap);
        </script>
    @endpush
</x-app-layout>